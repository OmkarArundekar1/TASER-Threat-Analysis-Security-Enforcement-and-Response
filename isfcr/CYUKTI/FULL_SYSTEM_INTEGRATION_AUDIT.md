...
| `rag/campaign_retriever.py` | TF-IDF over historical campaign narratives | Real | Investigation `CAMPAIGN_NARRATIVE_SEARCH` **only** — no standalone API route | PARTIALLY INTEGRATED (investigation-only, not independently queryable) |
